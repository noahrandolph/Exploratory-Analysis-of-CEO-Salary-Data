Exploratory Analysis of CEO Salary Data
================
...
```
    ...
    ## 182    637  45 Attended College    1      3      1      -1     -1
    ## 179    677  31 Attended College    1      3      1      -1     -1
    ## 180    173  55 Attended College    1      3      1      -1     -1
    ## 178    379  55 Attended College    1      4      2      -1     -1
    ## 181    873  61 Attended College    1      3      1      -1     -1
...
![](README_files/figure-markdown_github/market%20value%20histogram-1.png)
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##  -463.0    34.0    63.0   205.5   207.0  2700.0

We see that there are negative profits but the number of companies with negative profits may be low as the first quartile value is still positive. There is a wide range in values with the maximum profit going as high as 13 times the 3rd quartile value. The mean being much higher than the median and even more than the third quartile values indicates the presence of a few very high profit values.
...
There is a wide range in the number of years CEOs have stayed with their companies. The mean and median are almost equal, thus there should be no skew of the data.
...
Since graduate school (grad) is a categorical variable, we create a factor variable and assign levels of "Attended" and "Did Not Attend" to it.
...
The plot above, with its linear regression line, shows a clear positive relationship between salary and the *l**o**g*<sub>10</sub> of market value. The correlation, below, also shows that indeed some relation exists. However, the relationship cannot be said to be linear, since market value was plotted in *l**o**g*<sub>10</sub> scale.
...
```
    ...
    ##         Profit < 0   0 < Profit < 125 125 < Profit < 250 
    ##                 10                106                 28 
    ##       250 < Profit 
    ##                 35
...
```
    ...
    ##    <3 yrs   3-6 yrs  6-10 yrs 10-20 yrs 20-40 yrs 
    ##        34        53        37        40        15
...
```
    ...
    ##       <10 10-20 yrs 20-30 yrs 30-40 yrs 40-60 yrs 
    ##        43        33        36        56        11
...
```
    ...
    ##   <40 yrs 40-50 yrs 50-60 yrs 60-70 yrs 70-90 yrs 
    ##         5        31        81        54         8
